"""AirRaid Deep W-Learning trainer with shared Q/W networks.

Analogous to bidding_gridworld/dwn.py but for the OCAtari AirRaid environment.
...
@dataclass
class AirRaidDWNArgs:
    """Configuration for AirRaid Deep W-Learning trainer."""

    exp_name: str = "airraid_dwn"
    seed: int = 1
...
class AirRaidDWNTrainer:
    """Deep W-Learning trainer for OCAtari AirRaid with shared Q/W networks.
    ...
    def __init__(self, args: AirRaidDWNArgs, callbacks: Optional[dict] = None):
        self.args = args
        ...
        self.envs: Optional[AirRaidEnv] = None
    ...
    def setup(self):
        ...
        print("AirRaid DWN Trainer initialized")
    ...
    def train(self):
        ...
        while global_step < args.total_timesteps:
            ...
            done_mask = dones > 0.5
            if done_mask.any():
                # AirRaidEnv.step() auto-resets done envs but does not reset

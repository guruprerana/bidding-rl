"""
Single-agent PPO trainer for OCAtari Air Raid.
"""
...
class AirRaidSingleAgent(nn.Module):
    def __init__(
        self,
        obs_dim: int,
        action_space_n: int,
...
class AirRaidSingleAgentPPOTrainer(SingleAgentPPOTrainerBase):
    def __init__(self, args: AirRaidSingleAgentArgs, callbacks=None):
    ...
    def save_model(self, path: str | None = None):
        torch.save(self.agent.state_dict(), path or "airraid_single_agent.pt")

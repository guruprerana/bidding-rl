#!/usr/bin/env python3
"""
Plot learning curves for the bid upper bound comparison experiment.
...
Usage:
    ...
    python experiment_scripts/plots/plot_bid_upper_bound_comparison.py --smooth 3
"""
...
EXPERIMENTS = [
    ("bid_ub_cmp_bub0", "Upper Bound = 0 (Random)"),
    ("bid_ub_cmp_bub2", "Upper Bound = 2"),
    ("bid_ub_cmp_bub4", "Upper Bound = 4"),
    ("bid_ub_cmp_bub6", "Upper Bound = 6"),
]
...
def main():
    ...
    output_path = args.output or os.path.join(log_dir, "gridworld_bid_upper_bound_learning_curves.png")

#!/usr/bin/env python3
"""
Plot learning curves for the bid penalty comparison experiment.

Usage:
    python experiment_scripts/plots/plot_bid_penalty_comparison.py
    python experiment_scripts/plots/plot_bid_penalty_comparison.py --log-dir logs/gridworld_bid_penalty_comparison
    python experiment_scripts/plots/plot_bid_penalty_comparison.py --smooth 3
"""
...
EXPERIMENTS = [
    ("bid_penalty_cmp_p0",   "Penalty = 0"),
    ("bid_penalty_cmp_p0p1", "Penalty = 0.1"),
    ("bid_penalty_cmp_p1",   "Penalty = 1"),
    ("bid_penalty_cmp_p2",   "Penalty = 2"),
    ("bid_penalty_cmp_p5",   "Penalty = 5"),
]
...
def main():
    ...
    parser.add_argument("--log-dir", default="logs/gridworld_bid_penalty_comparison")
    ...
    output_path = args.output or os.path.join(log_dir, "gridworld_bid_penalty_learning_curves.png")

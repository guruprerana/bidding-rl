#!/usr/bin/env python3
"""
Plot peak performance bar chart for the bid penalty comparison experiment.
...
def main():
    ...
    output_path = args.output or os.path.join(log_dir, "gridworld_bid_penalty_bar_chart.png")
    ...
    ax.bar(x, bar_heights, yerr=[err_lo, err_hi],
           capsize=5, width=0.6, color="steelblue", alpha=0.8)

    ax.set_xticks(x)
    ax.set_xticklabels(labels, fontsize=18)
    ax.set_xlabel("Bid Penalty", fontsize=20)
